...
echo ""
echo "📝 Next steps:"
echo "1. Edit .env file with your Google OAuth credentials and camera device IDs:"
echo "   nano .env"
echo ""
echo "2. Get your camera device IDs:"
echo "   node deploy/detect-cameras.js"
echo "   (Follow the instructions to get device IDs from browser console)"
echo ""
echo "3. Set up ngrok authentication (optional for stable URLs):"
echo "   ngrok authtoken YOUR_AUTH_TOKEN"
echo ""
echo "4. Start the service:"
echo "   ./deploy/start-mac-service.sh"
echo ""
echo "5. Configure Vercel with the ngrok URL shown after startup"
echo ""
