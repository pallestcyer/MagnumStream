                ...
                <TableBody>
                  {nonPurchasers.slice(0, 50).map((p) => (
                    <TableRow key={p.id} className="hover:bg-muted/50 border-b border-border group">
                      ...
                      <TableCell>
                        {p.packagePurchased === null ? <Badge variant="secondary" className="bg-muted text-muted-foreground hover:bg-muted/80">No Purchase</Badge> :
                          p.packagePurchased === 'video_only' ? <Badge variant="secondary" className="bg-orange-500/20 text-orange-700 dark:text-orange-300 hover:bg-orange-500/30">Bought Video</Badge> :
                          <Badge variant="secondary" className="bg-yellow-500/20 text-yellow-700 dark:text-yellow-300 hover:bg-yellow-500/30">Bought Photos</Badge>}
                      </TableCell>
                      <TableCell>
